...
import {wmsLayer} from '../geoserverComponent/wms'
import {styleDepto,styleMpio,styleHighlight} from './layer-style/layers-style'
...
//Capas Basica
// var deptos = wmsLayer('i2d','dpto_politico','Departamentos',false); 
...
export var layer_base = new GroupLayer({
    fold:'close',
    title: 'Capas Base',
    layers: [streetmap, otm, bw, terrain ,deptos, mpios/*, Deptos, Mpios*/],
    name: 'Capas Base'
});
